                    ...
                    <Box w={{ lg: '35%' }}>
                        ...
                        >
                            <Tooltip label='LinkedIn' placement='top'>
                                <IconButton
                                    as={Link}
                                    href={'https://www.linkedin.com/in/manoj-padhy-755b0b1b3?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BBG3%2F%2FoawSV6HG%2FIoHm4O%2FA%3D%3D'} isExternal
                                    aria-label="linkedin"
                                    variant="ghost"
                                    size="lg"
                                    isRound={true}
                            ...
                            <Tooltip label='Github' placement='top'>
                                ...
                                <IconButton
                                    as={Link}
                                    href={'https://github.com/Manojkumar7978'} isExternal
                                    aria-label="github"
                                    variant="ghost"
                                    size="lg"
                                    isRound={true}
