                        ...
                        <SimpleGrid minChildWidth='100px' spacing='40px'>
                            {
                                techstack.map((el, ind) => {
                                    return <Box className="skills-card" cursor={'pointer'} _hover={{ boxShadow: 'xl', bg: 'whiteAlpha.800', transition: 'transform 0.5s', transform: 'scale(1.1)' }} height={'160px'} borderRadius={10} boxShadow={'md'} bg={'white'} p={3} maxW={'130px'} >
